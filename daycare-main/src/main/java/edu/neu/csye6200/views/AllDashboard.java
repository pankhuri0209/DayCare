...
//            JOptionPane.showMessageDialog(this, c.getTime().toString(), " Next renewal date ", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                    AllDashboard dash= new AllDashboard();
                  //  dash.setSize(200, 200);
                    dash.setResizable(true);
                    dash.setVisible(true);
               // new AllDashboard().setSize(500, 400).setVisible(true);
            }
        });
    }
